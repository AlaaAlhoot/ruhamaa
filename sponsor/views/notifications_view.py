"""
sponsor/views/notifications_view.py
صفحة الإشعارات — لوحة الكافل
"""
...
from sponsor.views.notifications_preview import NTYPE_ICONS
...
def notifications_data(request):
    ...
    available_types = list(
        all_qs.values_list('ntype', flat=True).distinct()
    )
    types_list = [
