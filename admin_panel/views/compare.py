...
from core.models import CustomUser, Notification, Payment, Aid
...
def compare_view(request):
    ...
    return render(request, 'admin_panel/compare.html', {
...
def compare_list(request):
    """قائمة المستفيدين للاختيار منها"""
